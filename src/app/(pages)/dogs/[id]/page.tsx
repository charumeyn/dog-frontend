      ...
      <section className="py-16">
        <div className="w-full max-w-screen-2xl mx-auto px-4">
          <div className="max-w-4xl">
            <p className="mb-2 text-gray-500 text-sm">Created by {dog?.shelter.name}</p>
            ...
            <div className="flex items-center justify-between pb-8 border-b border-gray-100">
              ...
              <div>
                <a href={""} className="font-medium px-8 py-3 border border-gray-300 rounded-full">Visit ➞</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex gap-x-5">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mb-3">$100 • 1 hr ago</p>
                <p className="text-gray-800 text-sm">Such a cute pup! I hope he's doing well.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="w-full max-w-screen-2xl mx-auto px-4">
          ...
          <div className="w-full max-w-screen-2xl mx-auto">
            ...
            <a className="mt-10 block table font-medium mx-auto px-8 py-3 border border-gray-300 rounded-full" href={`/fundraisers/`}>View all dogs</a>
          </div>
        </div>
      </section>
    </main>
