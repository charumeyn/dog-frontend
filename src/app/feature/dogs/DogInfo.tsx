...
const DogInfo: React.FunctionComponent<DogInfoProps> = ({ dog }) => {
  ...
  return (
    <>
      ...
      <p className="text-neutral-500 mb-8">Location</p>
      <div className="grid grid-cols-2 gap-x-10 gap-y-4">
        ...
        <div className="col-span-1">
          <p className="text-neutral-500 text-sm">Age</p>
          <p><strong></strong></p>
        </div>
        <div className="col-span-1">
          <p className="text-neutral-500 text-sm">Color</p>
          {dog?.color.map((color, i) =>
            <p key={i}><strong>{color}</strong></p>
          )}
        </div>
        <div className="col-span-1">
          <p className="text-neutral-500 text-sm">Gender</p>
          <p><strong>{dog?.gender}</strong></p>
        </div>
        <div className="col-span-1">
          <p className="text-neutral-500 text-sm">Coat</p>
